...
public class SystemInfoTest {
	...
	public static void printProcessor(CentralProcessor processor) {
        ...
        System.out.println("ProcessorID: " + processorIdentifier.getProcessorID());
    }
    ...
    public static void printCpu(CentralProcessor processor,OperatingSystem os) {
        ...
        //System.out.format("CPU load: %.1f%% (counting ticks)%n", processor.getSystemCpuLoadBetweenTicks(oldTicks) * 100);
		...
		List<LogicalProcessor> load = processor.ge
		for (LogicalProcessor avg : load) {
		    procCpu.append(String.format(" %.1f%%", avg.g * 100));
		}
    ...
    public static void printPowerSources(List<PowerSource> powerSources) {
    ...
    public static void printDisks(List<HWDiskStore> diskStores) {
    ...
    public static void printNetworkInterfaces(List<NetworkIF> networkIFs) {
    ...
    public static void printDisplays(List<Display> displays) {
    ...
    public static void printUsbDevices(List<UsbDevice> usbDevices) {
